...
export default  class Registe extends Component{
    ...
    LoginFetch(){
        const _this = this;
        const url = "http://49.234.73.158:8081/register";
        var code;
        let data = new URLSearchParams();
        data.append('email',_this.state.email);
    ...
    render() {
        return(
            <div>
                ...
                <ul className="group_input" style={{marginLeft:'570px'}}>
                ...
                <button type="button" id="btnSubmit" class="submit_btn" style={{marginTop:'30px',width:'300px',marginLeft:'570px'}} onClick={this.LoginFetch.bind(this)}>注册</button>
                <span className="agreement-tip" style={{marginBottom:'-100px'}}>点击「注册」按钮，即代表你同意<a href="javascript:;">《学·知协议》</a></span>
